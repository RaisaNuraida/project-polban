  ...
  <nav class="header-navbar navbar-expand navbar navbar-without-dd-arrow fixed-top navbar-semi-light">
    <div class="navbar-wrapper" style="background-color: #f4f5fa;">
      <div class="justify-content-end">
        <img src="assets/images/layanankealumnian.png" class="d-block mx-auto m-1 " style="width: 320px;"
        ...
        <nav class="navbar navbar-expand-lg">
          <div class="container justify-content-center">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-between align-items-center">
              ...
              <ul class="navbar-nav">
                <li class="mx-2 h1">
                  <a style="color:#f4f5fa" href="<?= base_url('tracer') ?>">
                    <strong>
                      <?php if (!empty($my_data)): ?>
                        <?php foreach ($my_data as $row): ?>
                          <span class="h1" style="display: block; font-size: 2rem;"></span>
            ...
            <div class="card">
              <div class="card-header container p-1 m-0">
                <div class="d-flex justify-content-center">
                  <iframe class="mt-4 mb-4" width="550" height="309"
                    src="https://www.youtube.com/embed/dZsTR26OP84?si=QHZDbCOYucjnUQHL" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                    <a href="https://www.youtube.com/embed/dZsTR26OP84?si=QHZDbCOYucjnUQHL">
                    </a>
                  </iframe>
                </div>
                ...
                <div class="mr-3 ml-3 text-justify">
                  ...
                  <div class="d-flex justify-content-center m-4">
                    <a type="button" class="btn btn-glow btn-round btn-bg-gradient-x-red-pink"

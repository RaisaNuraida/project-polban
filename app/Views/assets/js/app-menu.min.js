!(function (n, e, d) {
  ...
  (d.app.menu = {
    ...
    manualScroller: {
      ...
      update: function () {
        if (this.obj) {
          ...
          if (!0 === d(".main-menu").data("scroll-to-active"))
            (e =
              0 < d(".main-menu-content").find("li.active").parents("li").length
                ? d(".main-menu-content")
                    .find("li.active")
                    .parents("li")
                    .last()
                    .position()
                : d(".main-menu-content").find("li.active").position()),
              setTimeout(function () {
                void 0 !== e &&
                  d.app.menu.container
                    .stop()
      ...
      updateHeight: function () {
        ("vertical-menu" != l.data("menu") &&
          ...
          (d(".main-menu-content").css(
            "height",
            d(n).height() -
              d(".header-navbar").height() -
              d(".main-menu-header").outerHeight() -
              d(".main-menu-footer").outerHeight()
          ),
          this.update());
      },
    },
    ...
    drillDownMenu: function (e) {
      d(".drilldown-menu").length &&
        ("sm" == e || "xs" == e
          ? "true" == d("#navbar-mobile").attr("aria-expanded") &&
            d(".drilldown-menu").slidingMenu({ backLabel: !0 })
          : d(".drilldown-menu").slidingMenu({ backLabel: !0 }));
    },
    change: function (e) {
      ...
      ("vertical-menu" !== s && "vertical-menu-modern" !== s) ||
        ...
        d(".header-navbar").hasClass("navbar-brand-center") &&
          d(".header-navbar").attr("data-nav", "brand-center"),
        "sm" == n.name || "xs" == n.name
          ? d(".header-navbar[data-nav=brand-center]").removeClass(
              "navbar-brand-center"
            )
          : d(".header-navbar[data-nav=brand-center]").addClass(
              "navbar-brand-center"
            ),
        ...
        "horizontal-menu" == s &&
          ("sm" == n.name || "xs" == n.name
            ? d(".menu-fixed").length && d(".menu-fixed").unstick()
            : d(".navbar-fixed").length && d(".navbar-fixed").sticky()),
      ...
      l.addClass("changing-menu"),
        ...
        l.hasClass("vertical-layout") &&
          (l.hasClass("menu-open") || l.hasClass("menu-expanded")
            ? (d(".menu-toggle").addClass("is-active"),
              "vertical-menu" === l.data("menu") &&
                d(".main-menu-header") &&
                d(".main-menu-header").show())
            : (d(".menu-toggle").removeClass("is-active"),
              "vertical-menu" === l.data("menu") &&
                d(".main-menu-header") &&
                d(".main-menu-header").hide())),
        setTimeout(function () {
          ...
          function () {
            "horizontal-menu" == l.data("menu") &&
              ...
              ("vertical-menu" != l.data("menu") &&
                ...
                (d(".main-menu-content").css(
                  "height",
                  d(n).height() - d(".header-navbar").height()
                ),
                d(".main-menu-content").hasClass("ps") ||
                  this.manualScroller.enable());
          }
        ));
    },
    toOverlayMenu: function (e) {
      ...
      "sm" == e || "xs" == e
        ...
        : l.hasClass("vertical-overlay-menu") &&
          l.removeClass("vertical-overlay-menu").addClass(n);
    },
    changeMenu: function (e) {
      ...
      var n = d('div[data-menu="menu-wrapper"]'),
        a =
          (d('div[data-menu="menu-container"]'),
      ...
      "sm" == e || "xs" == e
        ? (l
          ...
          d.app.nav.init(),
          d("ul.dropdown-menu [data-toggle=dropdown]").on(
            "click",
            function (e) {
              e.preventDefault(),
                e.stopPropagation(),
        ...
        d(".navigation-main")
          .on("mouseenter.app.menu", "li", function () {
            ...
            if (
              ...
              var s,
                t = d(".navbar-header").length
                  ? d(".navbar-header").height()
                  : 0;
              if (
                ((s = e.css("border-top")
                  ? t + e.position().top + parseInt(e.css("border-top"), 10)
                  : t + e.position().top),
                i
          ...
          d(".navbar-header, .main-menu")
            .on("mouseenter", function () {
              if (
                "vertical-menu-modern" == l.data("menu") &&
                (d(".main-menu, .navbar-header").addClass("expanded"),
                l.hasClass("menu-collapsed"))
              ) {
            ...
            .on("mouseleave", function () {
              l.hasClass("menu-collapsed") &&
                ...
                setTimeout(function () {
                  if (
                    0 === d(".main-menu:hover").length &&
                    0 === d(".navbar-header:hover").length &&
                    (d(".main-menu, .navbar-header").removeClass("expanded"),
                    l.hasClass("menu-collapsed"))
                  ) {
      ...
      adjustSubmenu: function (e) {
        ...
        (n = d(".navbar-header").height()),
          ...
          r
            ...
            .appendTo(".main-menu-content")
            .css({ top: i, position: "fixed", "max-height": t });

                                            ...
                                            <?php if (!empty($user)) : ?>
                                                ...
                                                <?php foreach ($user as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= $row['entries']; ?> <br>
                                                            <a class="btn btn-info btn-sm" style='font-size:10px;padding:2px 5px;color:white;' onclick="openTab(event, 'dataisian')">Lihat</a>
            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <!-- Table Kuesioner START-->
                        <div class="card tab-content" id="dataisian">
                            <div class="card-header ml-2 mr-2">
                                <div class="d-flex justify-content-between">

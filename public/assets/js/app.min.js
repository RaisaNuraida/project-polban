!(function (n, e, s) {
  ...
  s(n).on("load", function () {
    ...
    0 < n.length &&
      ...
      s('[data-toggle="tooltip"]').tooltip({ container: "body" });
    ...
    s(a).click(function (e) {
      ...
      0 < s(".navbar-hide-on-scroll").length &&
        (s(".navbar-hide-on-scroll.fixed-top").headroom({
          offset: 205,
          tolerance: 5,
          classes: {
            initial: "headroom",
      ...
      setTimeout(function () {
        s("body").hasClass("vertical-content-menu") &&
          (function () {
            ...
            s(".content-body").height() < e &&
              s(".content-body").css("height", e);
          })();
      }, 500),
      ...
      s('.card .heading-elements a[data-action="collapse"]').on(
        "click",
        function () {
          var e,
    ...
    "vertical-compact-menu" != t &&
      ...
      ("vertical-menu-modern" == c.data("menu")
        ...
        : s(".main-menu-content")
            ...
            .parents("li")
            .addClass("open")),
      ("vertical-compact-menu" != t && "horizontal-menu" != t) ||
        (s(".main-menu-content")
          .find("li.active")
    ...
    s(e).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
      return (
        ...
        0 < s("#collapsed-sidebar").length &&
          setTimeout(function () {
            c.hasClass("menu-expanded") || c.hasClass("menu-open")
              ? s("#collapsed-sidebar").prop("checked", !1)
